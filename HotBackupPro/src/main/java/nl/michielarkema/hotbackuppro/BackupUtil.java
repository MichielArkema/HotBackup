...
public final class BackupUtil {
    ...
    private static final DateTimeFormatter dateTimeFormatter = DateTimeFormatter.ofPattern("yyyy-MM-dd_HH_mm");
    ...
    /**
     * Gets the local time using the formatter.
     * @return The local formatted time.
     */
